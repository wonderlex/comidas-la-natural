...
public class Panel_calculo_gastos extends JPanel {
	...
	public Panel_calculo_gastos(int ancho,int alto) {
	...
	public void inicializar_componentes() {
		...
		pos_x_visualizador_compra = this.getWidth()/2 + (this.getWidth()/2 - ancho_visualizador)/2;
		pos_y_visualizador_compra = this.getHeight()/2 - alto/2;
		...
		pos_y_boton_imprimir = pos_y_visualizador_compra + alto_visualizador;	
